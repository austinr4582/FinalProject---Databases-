...
{
    public partial class frmLivingExpense : Form
    {
        private DataTable dt = new DataTable();
        private ReciptLiving selectedRecipt;
        public frmLivingExpense()
        {
            InitializeComponent();
        }
        ...
        {
            DataTable aTable = ReciptLiving.LivingExpensesTableWithBusinessName();
        ...
        private void frmLivingExpense_Load(object sender, EventArgs e)
        {
            DataTable dt = DBEngine.GetTable("Select reciptID as ReciptID from LivingExpenses");
            showRecipt();
        }

        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            dataGridView1.DataSource = ReciptLiving.serach("Business like '%" + txtSearch.Text.Trim() + "%'");
        }
        ...
        private void dataGridView1_RowEnter_1(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                ReciptLiving rec = new ReciptLiving(SelRow);
