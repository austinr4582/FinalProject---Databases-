...
{
    public partial class frmNeedPay : Form
    {
        private DataTable dt = new DataTable();
        private ReciptFull selectedRecipt;
        public frmNeedPay()
        {
            InitializeComponent();
        }
        ...
        private void frmNeedPay_Load(object sender, EventArgs e)
        {
            DataTable aTable = ReciptFull.FullTableWithBusinessName();
            dataGridView1.DataSource = aTable;
            dataGridView1.AutoResizeColumns();
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                ReciptFull rec = new ReciptFull(SelRow);
